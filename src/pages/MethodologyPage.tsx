        ...
        <article className="lg:col-span-2 space-y-10 text-ink leading-relaxed">
          ...
          <Section id="data" title="2. Data sources">
            <ul className="space-y-2 list-disc pl-5">
              <li><strong>Public benchmark municipal service request data:</strong> actual open municipal complaint records used to demonstrate the complaint workflow — real intake volume, categories, and complaint patterns.</li>
              <li><strong>Normalized municipal complaint schema:</strong> the benchmark data is cleaned and mapped into a standardized, Brampton compatible complaint workflow schema so records can be compared and processed consistently.</li>
            ...
            <div className="mt-4 rounded-md border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-ink-muted">
              <span className="font-semibold text-navy-900">Current dataset:</span> public benchmark municipal service request data used to demonstrate the complaint workflow. Brampton ward boundaries provide real local context where available. This is not Brampton operational complaint data.
            </div>
          </Section>
          ...
          <Section id="limits" title="7. Known limitations">
            <ul className="space-y-2 list-disc pl-5">
              <li>Public benchmark municipal service request data reflects real municipal complaint patterns, but it is not Brampton operational complaint data. Brampton specific calibration requires City provided complaints, tickets, patrol logs, closure outcomes, and case management data.</li>
