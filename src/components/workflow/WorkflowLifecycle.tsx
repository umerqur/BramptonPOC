      ...
      stages: [
        {
          ...
          body: 'A resident complaint arrives from a 311-style channel — web, phone, mobile, or walk-in. In this POC, public benchmark municipal service request records stand in for live municipal intake.',
          tag: 'automated',
