 ...
 * explicit and unmissable: NYC 311 benchmark data, decision support only,
    ...
    >
      <div className="flex items-start gap-2">
        ...
        <div className="space-y-1">
          <p className="font-semibold">NYC 311 benchmark — decision support only.</p>
          <ul className="list-disc space-y-0.5 pl-4 text-xs leading-relaxed text-amber-900/90">
            <li>This is a workload-planning view built on NYC 311 public benchmark data.</li>
